...
public class Loader extends Applet {
	...
	public static final String CLIENT_TITLE = "Kircide Gaming";
	public static final String FRAME_TITLE = "Kircide Gaming r."+VERSION+"";
	public static final String SERVER_IP = "66.226.55.31";
	public static final int SERVER_PORT = 30168;
